...
png(filename = 'fig/barplotPrePos.png')
...
## Bar plot with accuracy and error bars
...
png(filename = 'fig/barplotAccuracy.png')
...
png(filename = 'fig/confusionMatrix.png')
